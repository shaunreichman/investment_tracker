...
This module contains pure calculation functions specific to the tax domain.
...
def get_financial_year_dates(financial_year, tax_jurisdiction="AU"):
    """
    Get the start and end dates for a financial year based on tax jurisdiction.
    Args:
        financial_year (str): Financial year string (e.g., '2023-24' or '2023').
        tax_jurisdiction (str): Tax jurisdiction code (e.g., 'AU').
    Returns:
