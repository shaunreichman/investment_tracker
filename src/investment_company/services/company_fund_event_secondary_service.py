...
class CompanyFundEventSecondaryService:
        ...
        for fund_change in fund_changes:
            ...
            if fund_change_dict['field_name'] == 'start_date':
                ...
                if company.start_date is None or company.start_date > new_start_date:
                    ...
                    all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='start_date', old_value=old_start_date, new_value=new_start_date))
                    ...
                    if old_duration != new_duration:
                        all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='current_duration', old_value=old_duration, new_value=new_duration))
                        company.current_duration = new_duration

            # 2. Check the pnl of the fund
            elif fund_change_dict['field_name'] == 'pnl':
                all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='pnl', old_value=company.pnl, new_value=company.pnl+fund_change_dict['new_value']))
                company.pnl += fund_change_dict['new_value']
            elif fund_change_dict['field_name'] == 'realized_pnl':
                all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='realized_pnl', old_value=company.realized_pnl, new_value=company.realized_pnl+fund_change_dict['new_value']))
                company.realized_pnl += fund_change_dict['new_value']
            elif fund_change_dict['field_name'] == 'unrealized_pnl':
                all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='unrealized_pnl', old_value=company.unrealized_pnl, new_value=company.unrealized_pnl+fund_change_dict['new_value']))
                company.unrealized_pnl += fund_change_dict['new_value']
            elif fund_change_dict['field_name'] == 'realized_pnl_capital_gain':
                all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='realized_pnl_capital_gain', old_value=company.realized_pnl_capital_gain, new_value=company.realized_pnl_capital_gain+fund_change_dict['new_value']))
                company.realized_pnl_capital_gain += fund_change_dict['new_value']
            elif fund_change_dict['field_name'] == 'unrealized_pnl_capital_gain':
                all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='unrealized_pnl_capital_gain', old_value=company.unrealized_pnl_capital_gain, new_value=company.unrealized_pnl_capital_gain+fund_change_dict['new_value']))
                company.unrealized_pnl_capital_gain += fund_change_dict['new_value']
            elif fund_change_dict['field_name'] == 'realized_pnl_dividend':
                all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='realized_pnl_dividend', old_value=company.realized_pnl_dividend, new_value=company.realized_pnl_dividend+fund_change_dict['new_value']))
                company.realized_pnl_dividend += fund_change_dict['new_value']
            elif fund_change_dict['field_name'] == 'realized_pnl_interest':
                all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='realized_pnl_interest', old_value=company.realized_pnl_interest, new_value=company.realized_pnl_interest+fund_change_dict['new_value']))
                company.realized_pnl_interest += fund_change_dict['new_value']
            elif fund_change_dict['field_name'] == 'realized_pnl_distribution':
                all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='realized_pnl_distribution', old_value=company.realized_pnl_distribution, new_value=company.realized_pnl_distribution+fund_change_dict['new_value']))
            ...
            # 3. Check the status of the fund
                ...
                if old_fund_status == FundStatus.ACTIVE:
                    all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='total_funds_active', old_value=company.total_funds_active, new_value=company.total_funds_active-1))
                    company.total_funds_active -= 1
                elif old_fund_status == FundStatus.REALIZED:
                    all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='total_funds_realized', old_value=company.total_funds_realized, new_value=company.total_funds_realized-1))
                    company.total_funds_realized -= 1
                elif old_fund_status == FundStatus.COMPLETED:
                    all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='total_funds_completed', old_value=company.total_funds_completed, new_value=company.total_funds_completed-1))
                ...
                if company.total_funds_active == 0 and old_fund_status == FundStatus.ACTIVE:
                    all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='status', old_value=company.status, new_value=CompanyStatus.COMPLETED))
                    ...
                    all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='status', old_value=company.status, new_value=CompanyStatus.ACTIVE))
    ...
    def update_company_after_fund_creation(self, company_id: int, fund_commitment_amount: float, session: Session) -> list[DomainFieldChange]:
        ...
        all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='total_funds', old_value=company.total_funds, new_value=company.total_funds+1))
        all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='total_funds_active', old_value=company.total_funds_active, new_value=company.total_funds_active+1))
        all_company_changes.append(DomainFieldChange(domain_object_type=DomainObjectType.INVESTMENT_COMPANY, domain_object_id=company_id, field_name='total_commitment_amount', old_value=company.total_commitment_amount, new_value=company.total_commitment_amount+fund_commitment_amount))
