...
class TestFundCalculationService:
    ...
    def test_calculate_average_equity_balance(self, service, mock_fund):
        ...
        # OPTIMIZATION: Now need to set event_type to equity events for our optimization to work
        ...
        mock_event1.event_type = EventType.CAPITAL_CALL  # Equity event
        ...
        mock_event2.event_type = EventType.UNIT_PURCHASE  # Equity event
        ...
        mock_event3.event_type = EventType.UNIT_SALE  # Equity event
