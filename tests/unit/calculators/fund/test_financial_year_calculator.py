...
class TestFinancialYearCalculator:
    ...
    def test_calculate_financial_year_dates_half_year_different_years(self):
        ...
        test_cases = [
            ("2020", date(2020, 7, 1), date(2021, 6, 30)),
            ("2021", date(2021, 7, 1), date(2022, 6, 30)),
            ("2022", date(2022, 7, 1), date(2023, 6, 30)),
            ("2024", date(2024, 7, 1), date(2025, 6, 30)),
            ("2030", date(2030, 7, 1), date(2031, 6, 30)),
        ]
    ...
    def test_calculate_financial_year_dates_leap_year_half_year(self):
        ...
        assert fy_end == date(2025, 6, 30)  # End year is not leap year, but June 30 is always valid
    ...
    def test_calculate_financial_year_dates_boundary_years(self):
        ...
        test_cases = [
            ...
            ("1900", FundTaxStatementFinancialYearType.HALF_YEAR, date(1900, 7, 1), date(1901, 6, 30)),
            ("2099", FundTaxStatementFinancialYearType.CALENDAR_YEAR, date(2099, 1, 1), date(2099, 12, 31)),
            ("2099", FundTaxStatementFinancialYearType.HALF_YEAR, date(2099, 7, 1), date(2100, 6, 30)),
        ]
    ...
    def test_calculate_financial_year_dates_half_year_vs_calendar_year_difference(self):
        ...
        # Half year should start later and end later
        assert half_year_result[0] > calendar_year_result[0]  # July 1 > January 1
        assert half_year_result[1] > calendar_year_result[1]  # June 30 of next year > December 31
    ...
    def test_calculate_financial_year_dates_half_year_span(self):
        ...
        # Half year should span 365 days (or 366 in leap year for the end year)
        # Since we're testing 2023->2024, and 2024 is a leap year, it should be 366 days
