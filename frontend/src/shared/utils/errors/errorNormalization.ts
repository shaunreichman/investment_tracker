 ...
 * 
 * Core functions for categorizing, normalizing, and formatting errors.
 * These utilities work with the error types and interfaces defined in
 * shared/types/errors.ts to provide a standardized error handling approach.
 * 
 * @module shared/utils/errors
 */

import { ErrorType, ErrorSeverity, ErrorInfo } from '@/shared/types/errors';
