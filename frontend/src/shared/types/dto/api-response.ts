...
export interface ApiResponse<T = any> {
  ...
  /** Additional details about the response (often error details as a dictionary)
   * Matching backend behavior where ControllerResponseDTO.details (Dict[str, Any])
   * gets passed through to ApiResponse
   */
