...
```tsx
import { TabNavigation } from '@/components/shared/navigation';
...
### Breadcrumbs
Hierarchical navigation showing user's location in the application.
...
1. **Import from shared**: Always import from `@/components/shared/navigation`
