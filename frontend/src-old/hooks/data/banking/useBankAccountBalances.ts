 ...
 * 
 * @module hooks/data/banking/useBankAccountBalances
 */
...
export function useBankAccountBalances(
  ...
  const queryFn = useCallback(
    () => api.banking.getBankAccountBalances(params),
    [params]
  );
...
export function useBankAccountBalancesByAccount(
  ...
  const queryFn = useCallback(
    () => api.banking.getBankAccountBalancesByBankAccount(bankId, bankAccountId),
...
export function useBankAccountBalance(
  ...
  const queryFn = useCallback(
    () => api.banking.getBankAccountBalance(bankId, bankAccountId, balanceId),
...
export function useCreateBankAccountBalance(
  ...
  return useMutation<BankAccountBalance, CreateBankAccountBalanceRequest>(
    (data) => api.banking.createBankAccountBalance(bankId, bankAccountId, data)
  );
}
...
export function useDeleteBankAccountBalance(
  ...
  return useMutation<{ message: string; deleted_id: number }, void>(
    () => api.banking.deleteBankAccountBalance(bankId, bankAccountId, balanceId)
  );
}
