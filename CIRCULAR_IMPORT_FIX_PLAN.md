...
|------|-------|-------|--------------|
| **1** | Phase 1 | Remove direct imports from models | Models no longer import events/services |
| **2** | Phase 2 | Enhance service layer | Service methods for all fund operations |
| **3** | Phase 3 | Refactor model methods | Models use service delegation |
| **4** | Phase 4 | Refactor event handlers | Event handlers use dependency injection |
| **5** | Phase 5 | Testing & validation | All tests pass, no circular imports |
